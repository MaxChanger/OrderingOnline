...
//			shoprl.setOnClickListener(new jumptologin());
	...
	public void updateAmount(BigDecimal amount) {
		if (amount.compareTo(new BigDecimal(0.0)) == 0) {
			...
			behavior.setState(BottomSheetBehavior.STATE_COLLAPSED);
		} else if (amount.compareTo(new BigDecimal(8.0)) < 0) {
			car_limit.setText("还差 ¥" + new BigDecimal(8.0).subtract(amount) + " 可点餐");
			car_limit.setTextColor(Color.parseColor("#a8a8a8"));
			car_limit.setBackgroundColor(Color.parseColor("#535353"));
...
//	private class jumptologin implements OnClickListener {
//
//		@Override
//		public void onClick(View view) {
//			Intent intent = new Intent("cn.fanrunqi.materiallogin.MainActivity.class");
