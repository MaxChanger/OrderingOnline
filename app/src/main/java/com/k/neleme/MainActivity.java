...
public class MainActivity extends BaseActivity implements AddWidget.OnAddClick {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        initViews();
        TextView dataTextView = (TextView) findViewById(R.id.tv_shop_name);
        dataTextView.setText(name);
        ...
        car_limit.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View v){
                if( amount.compareTo(new BigDecimal(8.0)) > 0 ){
                    Intent intent = new Intent(MainActivity.this, com.k.neleme.payui.MainActivity.class);
                    TextView tv01;
                    tv01 = (TextView) findViewById(R.id.tv_amount);
                    String money = tv01.getText().toString();
                    intent.putExtra("pay_money", money);
                    startActivity(intent);
                }
                else{
                    Toast.makeText(MainActivity.this , "未达到点餐金额", Toast.LENGTH_SHORT).show();
                }
            }
        });
